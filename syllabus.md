...
## Learning Goal
By the end of the program, students can design, build, test, secure, and deploy a production-style Java backend service with Spring Boot, PostgreSQL, Docker, and Kubernetes fundamentals.
...
**In-class coverage:**
- [ ] Variables, naming conventions, and memory basics
...
### Lesson 4: Control Flow and Methods
**In-class coverage:**
