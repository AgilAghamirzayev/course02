...
Users do not need references to every other user.
...
The channel does not need to manually call each user in a hardcoded way.
...
Each user action can be represented as a command.
