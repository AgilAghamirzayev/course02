...
- Creating user role object by role name
...
```java
User user = new User("Ali", "Mammadov", "ali@example.com", null, null, 25);
```
...
The app can create payment methods based on user choice.
