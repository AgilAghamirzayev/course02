...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        BufferedImage originalImage = loadImage(SOURCE_FILE);
...
//    recolorSingleThreaded(originalImage, resultImage);
    ...
    private static BufferedImage loadImage(String sourceFile) throws IOException {
        try (InputStream inputStream = Main.class.getClassLoader().getResourceAsStream(sourceFile)) {
            if (inputStream != null) {
        ...
        File[] candidates = {
                new File(sourceFile),
                new File("src/main/resources/" + sourceFile),
                new File("target/classes/" + sourceFile)
        };
        ...
        throw new IOException("Image file not found or unreadable: " + sourceFile);
    }
